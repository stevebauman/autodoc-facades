...
Autodoc Facades uses the official Laravel [Facade Documenter](https://github.com/laravel/facade-documenter) and [Lody](https://github.com/lorisleiva/lody) by [@lorisleiva](https://github.com/lorisleiva) to easily generate doc annotations for your application's Laravel facades using the `@see` annotation with a single command:
